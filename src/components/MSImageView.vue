<template>
<div class="ms-image-view" :class="classes" :style="styles">
  <slot v-if="stage === 'show-loading'" name="preload-image">
    <div class="view-absolute" style="display: flex; justify-content: center; align-items: center">
      <svg :style="{fontSize: defaultIconSize}" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
